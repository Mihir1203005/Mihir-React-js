...
const EditProduct = () => {
  ...
  return (
    <div>
      <h2 style={{backgroundColor:"red"}}>Edit Product</h2>
      <br />
      <div style={{display:"flex", justifyContent:"space-evenly"}}>
        ...
        <form onSubmit={handleSubmit} style={{border:"1px solid teal", borderRadius:"10px", width:"35%"}}>
          ...
          /> <br /><br />
          <button type="submit" style={{backgroundColor:"red"}}>Edit Product</button>
        </form>
      </div>
      <br />
      {/* <h2>Edit History</h2> */}
      <table style={{border: "1px solid black", borderCollapse: "collapse",Width:"80%"}}>
        <thead>
          <tr>
            <th style={{border: "1px solid black",backgroundColor:"red"}}>Image</th>
            <th style={{border: "1px solid black",backgroundColor:"red"}}>Title</th>
            <th style={{border: "1px solid black",backgroundColor:"red"}}>Category</th>
            <th style={{border: "1px solid black",backgroundColor:"red"}}>Price</th>
            <th style={{border: "1px solid black",backgroundColor:"red"}}>Description</th>
          </tr>
        </thead>
        <tbody>
